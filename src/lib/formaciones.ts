...
export const FORMACIONES: Formacion[] = [
  ...
  },
  {
    ...
    huecos: [
      { id: "por", label: "Portero", top: 92, left: 50 },
      { id: "dfc1", label: "Central", top: 78, left: 68 },
      { id: "dfc2", label: "Central", top: 80, left: 50 },
      { id: "dfc3", label: "Central", top: 78, left: 32 },
      { id: "cd", label: "Carrilero derecho", top: 55, left: 85 },
      { id: "mc1", label: "Centrocampista", top: 58, left: 60 },
      { id: "mc2", label: "Centrocampista", top: 58, left: 40 },
      { id: "ci", label: "Carrilero izquierdo", top: 55, left: 15 },
      { id: "ed", label: "Mediapunta derecho", top: 40, left: 75 },
      { id: "delc", label: "Delantero centro", top: 15, left: 50 },
      { id: "ei", label: "Mediapunta izquierdo", top: 40, left: 25 },
    ],
  },
  {
    value: "1-5-4-1",
    ...
    huecos: [
      { id: "por", label: "Portero", top: 92, left: 50 },
      { id: "ld", label: "Lateral derecho", top: 74, left: 85 },
      { id: "dfc1", label: "Central", top: 78, left: 65 },
      { id: "dfc2", label: "Central", top: 80, left: 50 },
      { id: "dfc3", label: "Central", top: 78, left: 35 },
      { id: "li", label: "Lateral izquierdo", top: 74, left: 15 },
      { id: "ed", label: "Interior derecho", top: 50, left: 78 },
      { id: "mc1", label: "Centrocampista", top: 53, left: 58 },
      { id: "mc2", label: "Centrocampista", top: 53, left: 42 },
      { id: "ei", label: "Interior izquierdo", top: 50, left: 22 },
      { id: "delc", label: "Delantero centro", top: 16, left: 50 },
    ],
  },
];
